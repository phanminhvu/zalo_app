...

            {
                isEdit ? <Box className={'mt-4'} >
                    ...
                    <Text>Email</Text>
                        ...
                        />
                    <Radio  label="Nam" checked={sex === 0} onChange={e =>
                    {  if(e.target.checked){
                        setSex(0)
                    }}
                    } className={'mr-2'} />
                    <Radio  label="Nữ" onChange={e =>
                    {  if(e.target.checked){
                        setSex(1)
                    }}
                    }  checked={sex === 1}  />
                    <Text>Ngày sinh</Text>
                        ...
                        />
                </Box> :    <List className={'mt-4'}   divider={false} noSpacing>
                    ...
                    <List.Item prefix={<Icon icon="zi-calendar"/>} title={moment(authDt?.profile?.birthday).format("DD/MM/YYYY")}/>
