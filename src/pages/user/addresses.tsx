...
const UserAddresses: React.FunctionComponent = () => {
	...
	const [isFromSetting, setIsFromSetting] = useRecoilState<boolean>(isFromSettingState)
	...
	return (
		<Container>
			<div className='p-0 zui-container-background-color overflow-y-auto max-h-full' style={{ marginBottom: '0px' }}>
				{userAddresses && (
				...
				<Button
					className={`h-10  px-0 py-2 w-10/12 border-l-0 border-b-0 mb-20 rounded-full ml-auto mr-auto block`}
					onClick={async () => {
