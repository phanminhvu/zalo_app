    ...
    return (<Container>
        <Box mt={1} className={"bg-white p-4"}>
            ...
            <Input
                ...
                className="mt-2 border-slate-200"
            />
            {(cities && cities.length >0) && <Box mt={1}>
                <Select
                label="Thành phố"
                ...
                {districts && <Select
	                ...
	                value={(districtId && districts.find(dis => dis.name.localeCompare(districtId) === 0)) ? districts.find(dis => dis.name.localeCompare(districtId) === 0)?.id : ''}
	                onChange={(dId) => {
                ...
                {wards && <Select
                    ...
                    value={(wardId && wards.find(wd => wd.name.localeCompare(wardId) === 0)) ? wards.find(wd => wd.name.localeCompare(wardId) === 0)?.code : ''}
                    onChange={(wId) => {
            ...
            <Button.Group className={`flex w-full  bottom-0 mt-4`}>
                ...
                <Button className={`flex-1 border-l-0 border-r-0 border-b-0 rounded-none`} onClick={()=>{
                    navigate('/checkout');
                }}>
                    <p>
                        Đóng
