					...
					{affDashboardStats && (
						<Box p={4}>
							<Text
								size={'small'}
								bold
								className={`pt-2`}>{`Giới thiệu chưa thanh toán: ${affDashboardStats.unpaid}`}</Text>
							<Text
								size={'small'}
								bold
							...
							<Text
								size={'small'}
								bold
								className={`pt-2`}>{`Thu nhập chưa thanh toán: ${affDashboardStats.upaidearnings}`}</Text>
							<Text
								size={'small'}
								bold
				...
				<Tabs.Tab key="tab3" label="Các giới thiệu">
					{affDashboardReferrals && (
						<Box p={4}>
							<Table striped>
								<Table.Head>
									<Table.HeadCell>Tham chiếu</Table.HeadCell>
						...
						<Box p={4}>
							<Table striped>
								<Table.Head>
									...
									<Table.HeadCell>Url giới thiệu</Table.HeadCell>
							...
							onClick={async () => {
								const sData =
									referralNotifications === true
										? { payment_email: paymentEmail, referral_notifications: true }
