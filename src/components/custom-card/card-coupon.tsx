...
const CardCouponHorizontal = ({
    ...
    return coupon ? (
        <div
            className={`w-fit bg-white flex  items-start border ${(active === true) ? 'border-primary' : 'border-slate-300'}  rounded-lg overflow-hidden mr-2 px-2 py-1`}
            role="button"
            onClick={onClick}
        >
