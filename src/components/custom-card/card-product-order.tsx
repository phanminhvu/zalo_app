...
const CardProductOrder = ({ id, pathImg, nameProduct, salePrice, quantity, handleOnClick }: CardProductProps) => (
	<div
		...
		<div className='flex flex-row items-center gap-1'>
			...
			<Box p={0} m={0} className=' flex-none relative w-5 h-5 rounded-full bg-slate-100'>
				<div className=' absolute top-1/2 -translate-y-1/2 w-full text-center text-xs text-blue-700 '>{quantity}</div>
			</Box>
