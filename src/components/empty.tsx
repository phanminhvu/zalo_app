...
const EmptyBox = ({title,content}) => {
    return <Box mt={1} className={"bg-primary p-4"}>
    <Text size={'large'} className={ 'text-center text-white font-bold'}>{title}</Text>
    <Text size={'xSmall'} className={ 'text-center text-white'}>{content}</Text>
